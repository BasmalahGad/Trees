    ...
    while (true){
        ...
        switch (choice) {
            ...
            case 2:{
                ...
                // ptr to node.
                /*for (int i = 0; i < studentsDate.size(); ++i) {
                    avl.insert_student(studentsDate[i]);
                }*/
                AVL_menu(avl);
                break;
            }
    ...
    while (true){
        ...
        switch (BSTChoice) {
            ...
            case 3:{
                ...
                cin >> id;
                bst.search_student(id); // update to return bool
                break;
            }
            case 4:{
                bst.print();
    ...
    while (true){
        ...
        switch (AVLChoice) {
            case 1:{
                ...
                avl.insert_student(n,student); // what "some_node" should be ?
            ...
            case 2:{
                cout << "Please enter the ID of the student you want to remove: \n";
                cin >> id;
                avl.delete_student(n,id); // what "some_node" should be ?
